export const products_dev = [
  {
    id: 1,
    name: "Túi xách 1",
    des: "Túi handmade của chúng tôi được làm từ các chất liệu tự nhiên cao cấp như vải bố, vải lanh, len... được thiết kế và may thủ công tinh tế bởi các nghệ nhân có kinh nghiệm. Mỗi sản phẩm đều có một độ hoàn thiện cao, đảm bảo sự chắc chắn và độ bền vượt trội.",
  ...
  },
  {
    id: 2,
    name: "Túi xách 2",
    des: "Sản phẩm túi handmade của chúng tôi có thiết kế đa dạng, phù hợp với nhiều phong cách và mục đích sử dụng khác nhau, từ túi xách thời trang đến túi đựng laptop. Chúng tôi đặc biệt chú trọng đến chi tiết và sự tinh tế trong từng đường may để tạo nên một sản phẩm hoàn hảo và mang tính cá nhân cao cho khách hàng.",
...
export const stores_dev = [
  {
    id: 1,
    name: "Kho tổng",
    loc: "108 Phan Đình Phùng, Hà Nội",
  },
  {
    id: 2,
    name: "Kho A",
